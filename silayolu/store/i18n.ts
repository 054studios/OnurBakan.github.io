...
import enNews from '../constants/locales/en/news.json';
...
import trNews from '../constants/locales/tr/news.json';
...
import nlNews from '../constants/locales/nl/news.json';
...
import deNews from '../constants/locales/de/news.json';
...
import frNews from '../constants/locales/fr/news.json';
...
i18n.use(initReactI18next).init({
  ...
  fallbackLng: 'en',
  resources: {
    en: { common: enCommon, tabs: enTabs, auth: enAuth, borders: enBorders, chat: enChat, voice: enVoice, challenges: enChallenges, news: enNews },
    tr: { common: trCommon, tabs: trTabs, auth: trAuth, borders: trBorders, chat: trChat, voice: trVoice, challenges: trChallenges, news: trNews },
    nl: { common: nlCommon, tabs: nlTabs, auth: nlAuth, borders: nlBorders, chat: nlChat, voice: nlVoice, challenges: nlChallenges, news: nlNews },
    de: { common: deCommon, tabs: deTabs, auth: deAuth, borders: deBorders, chat: deChat, voice: deVoice, challenges: deChallenges, news: deNews },
    fr: { common: frCommon, tabs: frTabs, auth: frAuth, borders: frBorders, chat: frChat, voice: frVoice, challenges: frChallenges, news: frNews },
  },
